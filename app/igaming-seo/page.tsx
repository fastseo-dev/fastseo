...
export const metadata: Metadata = {
  ...
  description: 'Specialist iGaming SEO for casinos, sports betting and poker. Rank in the most competitive gambling markets worldwide.',
  alternates: {
    canonical: 'https://www.fastseosolutions.com/igaming-seo/',
  },
};
    ...
    <div className="min-h-screen bg-void pt-[70px]">
      <div className="max-w-[1160px] mx-auto px-6 py-24">
        ...
        <p className="font-body text-[17px] text-text-muted max-w-[600px] leading-relaxed">
          Specialist iGaming SEO for casinos, sports betting and poker. Rank in the most competitive gambling markets worldwide.
        </p>
        <div className="mt-8">
          <a
            href="/contact/"
