...
export const metadata: Metadata = {
  ...
  description: 'Get recommended by ChatGPT, Gemini and Perplexity. Answer Engine Optimisation for AI search.',
  alternates: {
    canonical: 'https://www.fastseosolutions.com/ai-seo-services/',
  },
};
    ...
    <div className="min-h-screen bg-void pt-[70px]">
      <div className="max-w-[1160px] mx-auto px-6 py-24">
        ...
        <p className="font-body text-[17px] text-text-muted max-w-[600px] leading-relaxed">
          Get recommended by ChatGPT, Gemini and Perplexity. Answer Engine Optimisation for AI search.
        </p>
        <div className="mt-8">
          <a
            href="/contact/"
