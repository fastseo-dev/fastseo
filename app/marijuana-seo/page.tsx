...
export const metadata: Metadata = {
  title: 'Cannabis SEO Agency',
  description: 'Dispensary and cannabis brand SEO. Navigate restrictions and rank in a growing market.',
  alternates: {
    canonical: 'https://www.fastseosolutions.com/marijuana-seo/',
  },
};
    ...
    <div className="min-h-screen bg-void pt-[70px]">
      <div className="max-w-[1160px] mx-auto px-6 py-24">
        ...
        <p className="font-body text-[17px] text-text-muted max-w-[600px] leading-relaxed">
          Dispensary and cannabis brand SEO. Navigate restrictions and rank in a growing market.
        </p>
        <div className="mt-8">
          <a
            href="/contact/"
