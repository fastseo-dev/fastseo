...
export const metadata: Metadata = {
  title: 'About FastSEO',
  description: 'Meet the FastSEO team. Specialist SEO for iGaming, crypto, adult and SaaS since 2018.',
  alternates: {
    canonical: 'https://www.fastseosolutions.com/about/',
  },
};
    ...
    <div className="min-h-screen bg-void pt-[70px]">
      <div className="max-w-[1160px] mx-auto px-6 py-24">
        ...
        <p className="font-body text-[17px] text-text-muted max-w-[600px] leading-relaxed">
          Meet the FastSEO team. Specialist SEO for iGaming, crypto, adult and SaaS since 2018.
        </p>
        <div className="mt-8">
          <a
            href="/contact/"
