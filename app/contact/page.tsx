...
export const metadata: Metadata = {
  title: 'Contact FastSEO',
  description: 'Get in touch for a free SEO audit. We work with iGaming, crypto, adult and SaaS brands.',
  alternates: {
    canonical: 'https://www.fastseosolutions.com/contact/',
  },
};
    ...
    <div className="min-h-screen bg-void pt-[70px]">
      <div className="max-w-[1160px] mx-auto px-6 py-24">
        ...
        <p className="font-body text-[17px] text-text-muted max-w-[600px] leading-relaxed">
          Get in touch for a free SEO audit. We work with iGaming, crypto, adult and SaaS brands.
        </p>
        <div className="mt-8">
          <a
            href="/contact/"
