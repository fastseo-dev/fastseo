...
export const metadata: Metadata = {
  title: 'Crypto SEO Agency',
  description: 'Expert cryptocurrency SEO for exchanges, DeFi protocols, wallets and NFT projects.',
  alternates: {
    canonical: 'https://www.fastseosolutions.com/cryptocurrency-seo/',
  },
};
    ...
    <div className="min-h-screen bg-void pt-[70px]">
      <div className="max-w-[1160px] mx-auto px-6 py-24">
        ...
        <p className="font-body text-[17px] text-text-muted max-w-[600px] leading-relaxed">
          Expert cryptocurrency SEO for exchanges, DeFi protocols, wallets and NFT projects.
        </p>
        <div className="mt-8">
          <a
            href="/contact/"
