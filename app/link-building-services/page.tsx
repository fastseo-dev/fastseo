...
export const metadata: Metadata = {
  ...
  description: 'High-DA niche link building for competitive industries. Manual outreach and digital PR.',
  alternates: {
    canonical: 'https://www.fastseosolutions.com/link-building-services/',
  },
};
    ...
    <div className="min-h-screen bg-void pt-[70px]">
      <div className="max-w-[1160px] mx-auto px-6 py-24">
        ...
        <p className="font-body text-[17px] text-text-muted max-w-[600px] leading-relaxed">
          High-DA niche link building for competitive industries. Manual outreach and digital PR.
        </p>
        <div className="mt-8">
          <a
            href="/contact/"
