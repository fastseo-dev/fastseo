...
export const metadata: Metadata = {
  ...
  description: 'Compliant adult link building services. Editorial backlinks for adult brands.',
  alternates: {
    canonical: 'https://www.fastseosolutions.com/adult-linkbuilding/',
  },
};
    ...
    <div className="min-h-screen bg-void pt-[70px]">
      <div className="max-w-[1160px] mx-auto px-6 py-24">
        ...
        <p className="font-body text-[17px] text-text-muted max-w-[600px] leading-relaxed">
          Compliant adult link building services. Editorial backlinks for adult brands.
        </p>
        <div className="mt-8">
          <a
            href="/contact/"
