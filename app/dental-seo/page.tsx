...
export const metadata: Metadata = {
  ...
  description: 'Local and national dental SEO. Grow your patient base with targeted search campaigns.',
  alternates: {
    canonical: 'https://www.fastseosolutions.com/dental-seo/',
  },
};
    ...
    <div className="min-h-screen bg-void pt-[70px]">
      <div className="max-w-[1160px] mx-auto px-6 py-24">
        ...
        <p className="font-body text-[17px] text-text-muted max-w-[600px] leading-relaxed">
          Local and national dental SEO. Grow your patient base with targeted search campaigns.
        </p>
        <div className="mt-8">
          <a
            href="/contact/"
