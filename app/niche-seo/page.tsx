...
export const metadata: Metadata = {
  ...
  description: 'Specialist niche SEO services for regulated and competitive verticals.',
  alternates: {
    canonical: 'https://www.fastseosolutions.com/niche-seo/',
  },
};
    ...
    <div className="min-h-screen bg-void pt-[70px]">
      <div className="max-w-[1160px] mx-auto px-6 py-24">
        ...
        <p className="font-body text-[17px] text-text-muted max-w-[600px] leading-relaxed">
          Specialist niche SEO services for regulated and competitive verticals.
        </p>
        <div className="mt-8">
          <a
            href="/contact/"
