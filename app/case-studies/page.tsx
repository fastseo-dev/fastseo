...
export const metadata: Metadata = {
  ...
  description: 'FastSEO case studies. Real results for iGaming, crypto, SaaS and adult brands.',
  alternates: {
    canonical: 'https://www.fastseosolutions.com/case-studies/',
  },
};
    ...
    <div className="min-h-screen bg-void pt-[70px]">
      <div className="max-w-[1160px] mx-auto px-6 py-24">
        ...
        <p className="font-body text-[17px] text-text-muted max-w-[600px] leading-relaxed">
          FastSEO case studies. Real results for iGaming, crypto, SaaS and adult brands.
        </p>
        <div className="mt-8">
          <a
            href="/contact/"
